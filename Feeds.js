...
import { fetchFeedsOnMount, fetchFeedsDetailOnMount } from './feeds-utils';
...
export default class Feeds extends PureComponent {
  ...
  handleCreate = () => {
    ...
    // this.context.router.history.push(`${themeClientUrls.USER_PROFILE}/${themeClientUrls.FEEDS}/create`);
  };
  ...
  handleCreateCancel = () => {
    ...
    // this.context.router.history.push(`${themeClientUrls.USER_PROFILE}/${themeClientUrls.FEEDS}`);
  };
